...
plt.plot(timeData*200.0/100,pop_lp,'r',linewidth=4.1)
plt.plot(timeData*200.0/100,pop_up,'b',linewidth=4.1)
plt.plot(timeData*200.0/100,pop_dark,'k',linewidth=4.1)
plt.xlabel('Time (fs)')
plt.ylabel('Population')
plt.xlim([0,200])
plt.savefig("1_41eVCavity_1_79eVExcitation_24meVLambda.pdf",format='pdf',bbox_inches='tight')
