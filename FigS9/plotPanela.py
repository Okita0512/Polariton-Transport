...
print("Loading data\n")
st = time.time()
ρData = np.loadtxt("Pii_population_panela.txt")
ed = time.time()
...
plt.xlim([0,200])
plt.legend(['LP','UP','Dark'],frameon=False,fontsize=23.5,bbox_to_anchor=(0.06,0.2))
plt.savefig("panela.pdf",format='pdf',bbox_inches='tight')
