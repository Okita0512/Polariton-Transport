...
plt.plot(data0[:, 0] / dk, data0[:, 1] * conv, '-', linewidth = lw, color = color11, label = r"$\lambda$ = 6 meV")
plt.plot(data1[:, 0] / dk, data1[:, 1] * conv, '-', linewidth = lw, color = color22, label = r"$\lambda$ = 12 meV")
plt.plot(data2[:, 0] / dk, data2[:, 1] * conv, '-', linewidth = lw, color = color33, label = r"$\lambda$ = 24 meV")
...
plt.plot(data0[:, 0] / dk, data0[:, 2] * conv, '-', linewidth = lw, color = color11) #, label = r"$\lambda$ = 6 meV")
plt.plot(data1[:, 0] / dk, data1[:, 2] * conv, '-', linewidth = lw, color = color22)# , label = r"$\lambda$ = 12 meV")
plt.plot(data2[:, 0] / dk, data2[:, 2] * conv, '-', linewidth = lw, color = color33)# , label = r"$\lambda$ = 24 meV")
