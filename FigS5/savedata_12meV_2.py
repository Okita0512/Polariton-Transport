...
np.savetxt("band_struct_LP_lambda=12meV_2.txt", band_struct)
...
np.savetxt("group_vel_LP_lambda=12meV_2.txt", group_vel_LP)
np.savetxt("group_vel_UP_lambda=12meV_2.txt", group_vel_UP)
