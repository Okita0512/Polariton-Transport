...
np.savetxt("band_struct_LP_lambda=24meV.txt", band_struct)
...
np.savetxt("group_vel_LP_lambda=24meV.txt", group_vel_LP)
np.savetxt("group_vel_UP_lambda=24meV.txt", group_vel_UP)
